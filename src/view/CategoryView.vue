<template>
    <div>
            ...
            <div class="card">
                <div class="card-item" data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="1200">
                    ...
                    <div class="card-item-content">
                        <input type="text" class="input" placeholder="Nhập tên danh mục..." title="Tìm kiếm danh mục"
                            v-model="search">
                        <button class="button bg-[#F15B2B]" @click="findCategory">Tìm Kiếm</button>
        ...
        <CategoryForm title="Danh Mục" :status="status" :item="item" v-if="showForm" @close="closeForm" @success="success">
        </CategoryForm>
