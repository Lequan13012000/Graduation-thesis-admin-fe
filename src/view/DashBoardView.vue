                ...
                <div class="card-item">
                    ...
                    <div class="card-item-content">
                        <div class="report-container">
                            <div class="report report-1" data-aos="fade-down-right" data-aos-duration="1500">
                            ...
                            <div class="report report-2" data-aos="fade-down-right" data-aos-duration="1000">
                                <div class="report-icon">
                            ...
                            <div class="report report-3" data-aos="fade-down-left" data-aos-duration="1000">
                                <div class="report-icon">
                            ...
                            <div class="report report-4" data-aos="fade-down-left" data-aos-duration="1500">
                                <div class="report-icon">
                        ...
                        <div class="time-filter" data-aos="fade-left" data-aos-duration="1500">
                            ...
                            <div class="time-container">
                                <div class="time">
                                    <md-field>
                                        <label>Tháng</label>
                                        <md-select v-model="timeFilter.month" @md-selected="renderMonthReport">
                                            <md-option :value="item.id" v-for="(item, index) in monthNumber"
                                                :key="index + item.name">
                                                {{ item.name }}
                                            </md-option>
                                        </md-select>
                                ...
                                <div class="time">
                                    <md-field>
                                        <label>Năm</label>
                                        <md-select v-model="timeFilter.year" @md-selected="renderYearReport">
                                            <md-option :value="item.id" v-for="(item, index) in yearNumber"
                                                :key="index + item.id">
                                                {{ item.name }}
                                            </md-option>
                                        </md-select>
...
export default {
    ...
    methods: {
        getDataTotal() {
            this.hasLoader = true;
            this.$axios.get(`${api.AdminApi}/datatotal`, {
                params: {
        ...
        async renderMonthReport() {
            ...
            this.hasLoader = true;
            await this.$axios.get(`${api.AdminApi}/datachart/month`, {
                params: {
                    day: numberDate,
                    month: this.timeFilter.month,
                    year: this.timeFilter.year
        ...
        async renderYearReport() {
            this.hasChart = false
            this.hasLoader = true
            await this.$axios.get(`${api.AdminApi}/datachart/year`, {
                params: {
                    year: this.timeFilter.year
                }
            }).then(res => {
